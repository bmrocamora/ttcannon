...
More information on electronics design can be found [here](https://github.com/bmrocamora/ttcannon/blob/master/documentation/electronics_design.md).
...
More information on modelling can be found [here](https://github.com/bmrocamora/ttcannon/blob/master/documentation/speed_and_spin_modelling.md).
